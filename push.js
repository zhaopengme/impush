...
function init() {
  ...
  var html =
    '<div id="subscribe-slidedown-container" class="subscribe-slidedown-container subscribe-reset slide-down"><div id="subscribe-slidedown-dialog" class="subscribe-slidedown-dialog"><div id="normal-slidedown"><div class="slidedown-body" id="slidedown-body"><div class="slidedown-body-icon"><img alt="notification icon" src="https://i.loli.net/2021/01/19/ulhySi8znxdjYWk.png"></div><div class="slidedown-body-message">We\'d like to send you notifications for the latest news and updates.</div><div class="clearfix"></div><div id="subscribe-loading-container"></div></div><div class="slidedown-footer" id="slidedown-footer"><button class="align-right primary slidedown-button" id="subscribe-slidedown-allow-button">Allow</button><button class="align-right secondary slidedown-button" id="subscribe-slidedown-cancel-button">No Thanks</button><div class="clearfix"></div></div></div></div></div>'
