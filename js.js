      ...
      "granted" === n
        ? (Push.install(e),
          ...
          navigator.serviceWorker.ready
            ...
            .then((n) =>
              Push.push_sendSubscriptionToServer(n, "POST", e, "new")
            )
            .then((e) => e)
            .catch((e) => {
...
function init() {
  ...
  var html =
    '<div id="subscribe-slidedown-container" class="subscribe-slidedown-container subscribe-reset slide-down"><div id="subscribe-slidedown-dialog" class="subscribe-slidedown-dialog"><div id="normal-slidedown"><div class="slidedown-body" id="slidedown-body"><div class="slidedown-body-icon"><img alt="notification icon" src="https://img.onesignal.com/t/d0db51bb-30e5-434f-a477-8b3a22fbeb58.jpg"></div><div class="slidedown-body-message">We\'d like to send you notifications for the latest news and updates.</div><div class="clearfix"></div><div id="subscribe-loading-container"></div></div><div class="slidedown-footer" id="slidedown-footer"><button class="align-right primary slidedown-button" id="subscribe-slidedown-allow-button">Allow</button><button class="align-right secondary slidedown-button" id="subscribe-slidedown-cancel-button">No Thanks</button><div class="clearfix"></div></div></div></div></div>'
