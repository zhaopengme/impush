;(function () {
  ...
  var Layer = {
    create: function (options) {
      var html =
        '<div class="layer-shade"></div> <div class="layui-layer layui-layer-dialog"> <div class="layui-layer-content"> <div> <div class="layui-layer-close"> <img src="https://cdn.jsdelivr.net/gh/zhaopengme/impush@1.6/close.png" alt=""> </div> <div id="subscribe-button">' +
        options.content +
    ...
    var options = {
      ...
      ok: function () {
        Push.init({
          ...
          granted: function () {
            storage.setItem("subscribe-push", "true")
          },
          denied: function () {
            storage.setItem("deniedsubscribed", "true")
          },
